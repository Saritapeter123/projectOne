...
$("#submit").on("click", function() {
  ...
  const queryUrl = "https://cors-anywhere.herokuapp.com/https://api.yelp.com/v3/businesses/search?location=seattle" + "&categories=" + cuisine + "&price=" + dollarSignVal; // + "&radius=" + radiusVal;
