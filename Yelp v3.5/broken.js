            ...
            $("#submit").on("click", function() {
              ...
              const queryUrl = "https://cors-anywhere.herokuapp.com/https://api.yelp.com/v3/businesses/search?" + "latitude=" + latlonVal + "&categories=" + cuisine + "&price=" + dollarSignVal + "&limit=" + 6;// + "&radius=" + radiusVal;
